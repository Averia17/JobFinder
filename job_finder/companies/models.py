...
def logo_generate_upload_path(instance, filename):
...
class Company(BaseModel):
    ...
    employees_number = models.PositiveSmallIntegerField(
        _("Number of employees"), null=True, blank=True
    )
    email = models.EmailField(
        _("Email"), unique=True, max_length=256, null=True, blank=False
    )
    ...
    image = models.ImageField(_("Logo"), upload_to=logo_generate_upload_path, null=True, blank=True)
